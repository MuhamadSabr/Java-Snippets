...
public class Student {
    ...
    public int getYearsSinceInvolved(){
        return LocalDate.now().getYear() - yearEnrolled;
    }

    public int getAge(){
        return ageEnrolled + getYearsSinceInvolved();
    }
    ...
    public int getMonthsSinceActive(){
        ...
        for(String courseCode: engagementMap.keySet()){
            inactiveMonths = Math.max(inactiveMonths, getMonthsSinceActive(courseCode));
        }
    ...
    public static Student getRandomStudent(Course... courses){
        ...
        Student student = new Student(
                getRandomVal("AU", "KUR", "US", "UK", "IU", "GB", "CN"),
