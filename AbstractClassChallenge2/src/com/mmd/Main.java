...
public class Main {
    public static void main(String[] args) {
        MyLinkedList myLinkedList = new MyLinkedList(new Node("25"));
        myLinkedList.traverse(myLinkedList.getRoot());
        myLinkedList.addItem(new Node(23));
        ...
        myLinkedList.traverse(myLinkedList.getRoot());
        System.out.println("-".repeat(30));
        SearchTree searchTree = new SearchTree(new Node(30));
        searchTree.traverse(searchTree.getRoot());
        searchTree.addItem(new Node("30"));
        searchTree.removeItem(null);
        searchTree.addItem(new Node("333"));
        searchTree.removeItem(new Node(1));
